...
func main(){
	...
	assessments = append(assessments, Assessment{
		ID:1,
		Nama:"Alexander",
		Date:time.Date(2025, 5, 1, 10, 0, 0, 0, time.Local),
		Scores:[]int{4, 5, 3, 2, 4, 3, 4, 5, 4, 2, 3, 4, 3, 4, 5},
		TotalScore:59,
		Catatan:"Merasa cukup baik secara umum",
	})
	for {
		fmt.Println("\n=== Aplikasi Manajemen Kesehatan Mental ===")
		fmt.Println("1. Isi Self-Assessment")
		fmt.Println("2. Kelola Data Assessment")
		fmt.Println("3. Lihat Hasil dan Rekomendasi")
		fmt.Println("4. Mencari Hasil Assessment berdasarkan ID")
		fmt.Println("5. Urutkan Hasil Assessment")
		fmt.Println("6. Cetak Laporan")
		fmt.Println("7. Tambah Catatan")
